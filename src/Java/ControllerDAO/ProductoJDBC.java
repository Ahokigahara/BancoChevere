...
public class ProductoJDBC {
    ...
    private final String SQL_SELECT_ONE = "SELECT A.id, A.saldo, A.productoTipoId, A.terceroId FROM productos as A WHERE A.id=?";
    public Producto consultarProducto(Integer productoId, String mensaje){
        ...
        try{
            ...
            while(rs.next()){
                ...
                producto = new Producto(rs.getInt(1), rs.getDouble(2), productoTipo, tercero);
            }
    ...
    private final String SQL_SELECT_LIST = "SELECT A.id, A.saldo, A.productoTipoId, A.terceroId FROM productos as A WHERE A.terceroId=?";
    public List<Producto> consultarProductos(Integer terceroId, String mensaje){
        ...
        try{
            ...
            while(rs.next()){
                ...
                Producto producto = new Producto(rs.getInt(1), rs.getDouble(2), productoTipo, tercero);
